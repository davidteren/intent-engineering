...
architecture-supported only when its **Arch pack** is ✅ there (Rails, Python, and Laravel
today; each has a `frameworks/<stack>-architecture.md` + `resources/patterns/<stack>.yaml` +

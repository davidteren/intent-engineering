...
- `frameworks/` — per-stack convention docs (rails, ruby, react, typescript, python,
  laravel, express, swift-ios) plus `rails-architecture.md`, `python-architecture.md`,
  `laravel-architecture.md`, and `express-architecture.md` for the architecture lens.
  Variant headings: "Convention violation smells", "Least-astonishment traps".
...
- `patterns/` — YAML design-pattern catalogs (`rails.yaml` 14, `python.yaml` 13,
  `laravel.yaml` 14, `express.yaml` 12 patterns) + format README.
